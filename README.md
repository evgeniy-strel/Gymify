...
Дизайн и структура приложения разработаны на основе личного опыта и потребностей. При проектировании использовалась Figma AI.

## ⚙️ Бэкенд + БД

Серверная часть проекта доступна в отдельном репозитории: [https://github.com/evgeniy-strel/Gymify-backend](https://github.com/evgeniy-strel/Gymify-backend)
